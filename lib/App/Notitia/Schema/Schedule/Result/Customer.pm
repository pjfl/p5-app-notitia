package App::Notitia::Schema::Schedule::Result::Customer;
...
$class->has_many( journeys => "${result}::Journey", 'customer_id' );
...
App::Notitia::Schema::Schedule::Result::Customer - People and resource scheduling

=head1 Synopsis

   use App::Notitia::Schema::Schedule::Result::Customer;
