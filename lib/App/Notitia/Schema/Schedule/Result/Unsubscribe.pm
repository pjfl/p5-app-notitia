package App::Notitia::Schema::Schedule::Result::Unsubscribe;
...
use App::Notitia::DataTypes qw( foreign_key_data_type varchar_data_type );

my $class = __PACKAGE__; my $result = 'App::Notitia::Schema::Schedule::Result';

$class->table( 'unsubscribe' );
...
$class->set_primary_key( 'recipient_id', 'sink', 'action' );
...
sub validation_attributes {
   return { # Keys: constraints, fields, and filters (all hashes)
      ...
      fields          => {
         ...
         recipient_id => { validate => 'isMandatory' },
         sink         => {
            validate  => 'isMandatory isValidLength isValidIdentifier' },
      },
      level => 8,
...
App::Notitia::Schema::Schedule::Result::Unsubscribe - People and resource scheduling

=head1 Synopsis

   use App::Notitia::Schema::Schedule::Result::Unsubscribe;
