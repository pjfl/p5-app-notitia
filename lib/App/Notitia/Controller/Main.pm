...
sub dispatch_request {
   ...
   sub (POST + /mailshot-participents + ?*) { [ 'event/from_request',    @_ ] },
   sub (GET  + /mailshot-participents + ?*) { [ 'event/mailshot',        @_ ] },
   sub (POST + /mailshot-people       + ?*) { [ 'person/from_request',   @_ ] },
   sub (GET  + /mailshot-people       + ?*) { [ 'person/mailshot',       @_ ] },
