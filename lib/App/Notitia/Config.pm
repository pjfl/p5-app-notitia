...
has 'email_sender'    => is => 'ro',   isa => SimpleStr, default => NUL,
...
A simple string defaults to C<Notitia@local-domain>. Sender email address
for emails generated by Notitia. Reads /etc/mailname to determine local-domain
