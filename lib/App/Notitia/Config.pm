...
use App::Notitia::Util          qw( encrypted_attr mail_domain );
...
has 'schema_classes'  => is => 'ro',   isa => HashRef[NonEmptySimpleStr],
   builder            => sub { {
      ...
      'usertable'     => 'App::Notitia::Schema::UserTable', } };
...
A simple string defaults to C<Notitia@local-domain>. Sender email address for
emails generated by Notitia. Reads F</etc/mailname> to determine local-domain
and defaults to example.com.
